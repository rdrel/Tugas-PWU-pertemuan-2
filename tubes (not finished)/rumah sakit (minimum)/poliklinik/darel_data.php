<?php include_once('../darel_header.php'); ?>
	...
	<div class="box">
		...
		<h4>
			...
			<div class="pull-right">
				...
				<a href="darel_generate.php" class="btn btn-success btn-xs"><i class="glyphicon glyphicon-plus"></i> Tambah Poli</a>
			</div>
		</h4>
						...
						if(mysqli_num_rows($sql_poli) > 0){
							while($data = mysqli_fetch_array($sql_poli)){ ?>
								<tr>
									...
									<td><?= $data['darel_lokasi']; ?></td>
									<td align="center">
										<input type="checkbox" name="checked[]" class="check" value="<?= $data['darel_id_poli']; ?>">
									</td>
								</tr>
							<?php
							}
	...
	function edit(){
		document.proses.action = 'darel_edit.php';
